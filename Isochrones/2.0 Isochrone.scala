...
val osmPath = "/dbfs/datasets/graphhopper/osm/us-northeast/graphHopperData/"
...
// Getting Potential Depot Locations
val potential_locations = spark.read.table("isochrones.potential_locations")
...
.saveAsTable("isochrones.isochrones")

// COMMAND ----------

// MAGIC %sql
// MAGIC SELECT * FROM isochrones.isochrones;
